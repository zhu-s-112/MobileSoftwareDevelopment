...
```kotlin
My name is huangmeng
My student ID is 2025003032
I'm learning Kotlin!
```
...
```kotlin
fun main() {
    println("Student [2025003032] says hello")
}
```
...
```kotlin
fun main() {
    println("Hello, my name is [huangmeng]")
}
```
...
```kotlin
fun main() {
    println("ID: [2025003032]")
    println("Name: [huangmeng]")
...
```kotlin
fun main() {
    val huangmengDelivery: String = "2025003032"
    println("Package for huangmeng will arrive, tracking ID: " + huangmengDelivery + ".")
}
```
...
```kotlin
fun main() {
    val studentName:String = "huangmeng"
    val score: Int = 32
  	val bonus: Int = 2
    val total =score + bonus
...
```kotlin
fun main() {
    println(zhangweiGreeting(age = 2))      
    println(zhangweiGreeting("huangmeng", 3))
}

fun zhangweiGreeting(name: String = "2025003032", age: Int): String {
    return "Hello Birthday, $name! You are $age years old."
}
```
...
```kotlin
fun printHuangmengWeather(city: String, lowTemperature: Int, highTemperature: Int, chanceOfRain: Int){
    println("City: $city")
...
fun main() {
    printHuangmengWeather("Ankara", 27, 31, 82)
    printHuangmengWeather("Tokyo", 32, 36, 10)
    printHuangmengWeather("Cape Town", 59, 64, 2)
    printHuangmengWeather("Guatemala City", 50, 55, 7)
}
