...
```kotlin
fun main() {
    println("My name is jinxiaoyan")
    println("My student id is 2025003001")
...
fun main() {
    println("jinxiaoyan 2025003001 says hello")
}
```
...
```kotlin
fun main() {
    println("Hello, my name is jinxiaoyan")
}
```
...
```kotlin
fun main() {
    println("ID: 2025003001")
    println("Name: jinxiaoyan") 
...
```kotlin
fun main() {
    val numberOfMessages = "01"   // 替换 AB 为你的实际数值
    // 请使用字符串模板输出以下消息
