...
```kotlin
fun main(){
    println("My name is cailingjin")
    println("My student ID is 2025003009")
...
```kotlin
fun main() {
    println("Student [2025003009] says hello")
}
```
...
```kotlin
fun main() {
    println("Hello, my name is [cailingjin]")
}
```
...
```kotlin
fun main() {
    println("ID: [2025003009]")
    println("Name: [cailingjin]")
...
```kotlin
fun main() {
    val name: String ="cailingjin"
    val studentID = 2025003009
...
fun main() {
    ...
    println(printinfo("[cailingjin]", B))   
}

fun printinfo(name: String = "2025003009", age: Int): String {return "Hello,$name!Your age is $age."
}
```
...
```kotlin
fun main() {
    printCailingjinWeather("Ankara",27,31,82)
    printCailingjinWeather("Tokyo",32,36,10)
    printCailingjinWeather("Cape Town",59,64,2)
    printCailingjinWeather("Guatemala City",50,55,7)
}

fun printCailingjinWeather(city:String, lowTemp:Int, highTemp:Int, rainChance:Int){
    println("City:$city")
