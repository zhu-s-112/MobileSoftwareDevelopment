...
```kotlin
fun main() {
    println("My name is duxuey")
    println("My student ID is 2025003030")
...
```kotlin
fun main() {
    println("Student [2025003030] says hello")
}
```
---
...
```kotlin
fun main() {
    println("Hello, my name is [duxueyou]")
}
```
---
...
```kotlin
fun main() {
    println("ID: [2025003030]") 
    println("Name: [duxueyou]") 
...
```kotlin
fun main() {
    val duxueyouDelivery = "2025003030"  
    val name = "duxueyou" 
    println("Package for " + name + " will arrive, tracking ID: " + duxueyouDelivery + ".")
}
```
...
```kotlin
fun main() {
    println(duxueyouGreeting(age = 0))
    println(duxueyouGreeting("duxueyou", 3))
}
fun duxueyouGreeting(name: String = "2025003030", age: Int): String {
...
//运行结果
Walking 3000 steps burns 120.0 calories
---
...
```kotlin
fun main() {
    printDuxueyouWeather("Ankara", 27, 31, 82)
    printDuxueyouWeather("Tokyo", 32, 36, 10)
    printDuxueyouWeather("Cape Town", 59, 64, 2)
    printDuxueyouWeather("Guatemala City", 50, 55, 7)
}
fun printDuxueyouWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: Int) {
    println("City: $city")
