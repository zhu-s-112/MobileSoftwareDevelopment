...
```kotlin
fun main() {
    println("Student 2025003015 says hello")
}
```
...
```kotlin
fun main() {
    val chenyunchaoDelivery = "2025003015"
    println("Package for " + "chenyunchao" + " will arrive, tracking ID: " + chenyunchaoDelivery + ".")
}
```
...
fun main() {
    ...
    println(chenyunchaoGreeting(age = 5))          
    println(chenyunchaoGreeting("chenyunchao", 1)) 
}

fun chenyunchaoGreeting(name: String = "2025003015", age: Int): String {
    return "Hello, $name! Your age is $age. Welcome to Kotlin!"
}
```
...
```kotlin
fun main() {
    printChenyunchaoWeather("Ankara", 27, 31, "82%")
    printChenyunchaoWeather("Tokyo", 32, 36, "10%")
    printChenyunchaoWeather("Cape Town", 59, 64, "2%")
    printChenyunchaoWeather("Guatemala City", 50, 59, "0%")
}
fun printChenyunchaoWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: String) {
    println("City: $city")
