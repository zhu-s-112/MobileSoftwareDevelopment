...
fun main() {
    ...
    println("My name is guozirong")
    println("My student Id is 2025003037")
...
```kotlin
fun main() {
    println("Student 2025003037 says hello")
}
```
...
fun main() {
    val name:String = "郭子榕"
    val studentID: String = "2025003037"
...
```kotlin
fun main() {
    println(zhangweiGreeting(age = 7))
    println(zhangweiGreeting("guozirong", 3))
}

fun zhangweiGreeting(name: String = "2025003037", age: Int): String {
...
```kotlin
fun main() {
    val first = 30    // 替换为你的实际数值
    val second = 37   // 替换为你的实际数值
    // 请在此填写代码
    if (first > second){
        println("$first")
...
fun main() {
	...
	printGuozirongWeather("Ankara",27,31,82)
    printGuozirongWeather("Tokyo",32,36,10)
    printGuozirongWeather("Cape Town",59,64,2)
	printGuozirongWeather("Guatemala City",50,55,7)
    
}
fun printGuozirongWeather(City : String, Low:Int, High:Int, Chance:Int){
    println("City: Guatemala $City")
