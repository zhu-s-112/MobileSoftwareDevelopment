...
|------|------|------|
| `[朱彦霖]` | 你的姓名拼音（全小写） | `zhuyanlin` |
| `[2025003020]` | 你的完整学号 | `2025003020` |
| `A` | 学号**倒数第 1 位**数字 | `0` |
| `B` | 学号**倒数第 2 位**数字 | `2` |
| `C` | 学号**倒数第 3 位**数字 | `0` |
| `AB` | 学号**后两位**组成的整数 | `20` |
...
```
fun main() {
    println("My name is zhuyanlin")
    println("My student ID is 2025003020")
...
```
fun main() {
    println("Student 2025003020 says hello")
}
---
...
```
fun main() {
    println("Hello, my name is zhuyanlin")
}
---
...
```
fun main() {
    println("ID: 2025003020") 
    println("Name: zhuyanlin") 
...
```
fun main() {
    val name: String = "zhuyanlin"
    val stucedentID = 2025003020
...
```
fun main() {
    println(zhuyanlinGreeting(age = 0))
    println(zhuyanlinGreeting("zhuyanlin", 2)) 
}

fun zhuyanlinGreeting(name: String="2025003020", age: Int): String {
...
```
fun main() {
    printZhuyanlinWeather("Ankara", 27, 31, 82)
    printZhuyanlinWeather("Tokyo", 32, 36, 10)
    printZhuyanlinWeather("Cape Town", 59, 64, 2)
    printZhuyanlinWeather("Guatemala City", 50, 55, 7)
}

fun printZhuyanlinWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: Int) {
    println("City:$city")
