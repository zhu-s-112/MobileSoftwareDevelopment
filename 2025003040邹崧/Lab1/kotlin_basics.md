...
// 请将修正后的完整代码粘贴至此
fun main() {
    println("student 2025003040 says hello")
}
```
...
// 请将修正后的完整代码粘贴至此
fun main() {
    println("Hello, my name is zousong")
}
```
...
// 请将修正后的完整代码粘贴至此
fun main() {
    println("ID: 2025003040")
    println("Name: zousong")
...
// 请将完整代码粘贴至此
fun main() {
    val numberOfMessages = 40  // 替换 AB 为你的实际数值（学号后两位）
    // 使用字符串模板输出通知消息
...
// 请将完整代码粘贴至此
fun main() {
    // 声明变量：姓名拼音+Delivery，值为你的学号
    val zousongDelivery = "2025003040"
    // 使用 + 运算符串联字符串并输出
    println("Package for " + "zousong" + " will arrive, tracking ID: " + zousongDelivery + ".")
}
```
...
// 请将完整代码粘贴至此
fun main() {
    val studentName = "zousong"  // 替换为你的姓名拼音
    val score = 40               // 替换为你学号后两位的整数值
    val bonus = 0                // 替换为你学号最后一位
...
// 请将完整代码粘贴至此
fun main() {
    val operandOne = 4   // 学号倒数第2、3位组成的整数
    val operandTwo = 0   // 学号最后一位

    // 输出所有运算结果
    println("$operandOne + $operandTwo = ${operandOne + operandTwo}")
    println("$operandOne - $operandTwo = ${operandOne - operandTwo}")
    // 注意：Kotlin 整数除法会截断小数，这里 4 / 0 会抛出异常，因此使用安全判断
    if (operandTwo != 0) {
        println("$operandOne / $operandTwo = ${operandOne / operandTwo}")
    } else {
        println("$operandOne / $operandTwo = 除数不能为0")
    }
    println("$operandOne * $operandTwo = ${operandOne * operandTwo}")
    // 取余运算同样需要判断除数不为0
    if (operandTwo != 0) {
...
// 请将完整代码粘贴至此
fun main() {
    println(zousongGreeting(age = 0))                // A 替换为你学号最后一位
    println(zousongGreeting("zousong", 4))           // [姓名] 替换为你的姓名拼音，B 替换为学号倒数第二位
}

fun zousongGreeting(name: String = "2025003040", age: Int): String {
...
// 请将完整代码粘贴至此
fun main() {
    val first = 4    // 替换为学号倒数第2、3位整数
    val second = 40  // 替换为学号后两位整数
...
fun main() {
    // 调用自定义函数输出各个城市天气
    printZousongWeather("Ankara", 27, 31, "82%")
    printZousongWeather("Tokyo", 32, 36, "10%")
    printZousongWeather("Cape Town", 59, 64, "2%")
    printZousongWeather("Guatemala City", 50, 55, "7%")
}

// 封装天气信息输出逻辑的函数
fun printZousongWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: String) {
    println("City: $city")
