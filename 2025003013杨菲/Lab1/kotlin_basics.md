...
```kotlin
fun main() {
   	println("My name is yangfei")
	println("My student ID is 2025003013")
...
```kotlin
fun main() {
    println("Student 2025003013 says hello")
}
---
...
```kotlin
fun main() {
    println("Hello, my name is yangfei")
}
...
```kotlin
fun main() {
    println("ID: 2025003013")
    println("Name: yangfei")
...
```kotlin
fun main() {
    val numberOfMessages = 13
    println("You have 13 unread message.")
}
---
...
```kotlin
fun main() {
    val name:String="yangfei"
    val studentID:String="2025003013"
...
```kotlin
fun main() {
   var operandOne: Int=10
   val operandTwo: Int=3
    
   print("$operandOne + $operandTwo = ${operandOne + operandTwo}")
   print("$operandOne - $operandTwo = ${operandOne - operandTwo}")
   print("$operandOne * $operandTwo = ${operandOne * operandTwo}")
   print("$operandOne / $operandTwo = ${operandOne / operandTwo}")
   print("$operandOne % $operandTwo = ${operandOne % operandTwo}")
...
fun zhangweiGreeting(name: String="2025003013", age: Int): String {
...
```kotlin
fun main() {
    println(yangfeiGreeting(age = 3))
    println(yangfeiGreeting("yangfei", 1))
}
fun yangfeiGreeting(name: String="2025003013", age: Int): String {
...
```kotlin
fun printYangFeiWeather(City:String,Low:Int,High:Int,Rain:String){
    println("City:$City")
    println("Low temperature:$Low,Heigh temperature:$High")
    println("Chance of rain:$Rain")
}
fun main() {
    printYangFeiWeather("Ankara",27,31,"82%")
    printYangFeiWeather("Tokyo",32,36,"10%")
    printYangFeiWeather("Cape Town",59,64,"2%")
    printYangFeiWeather("Guatemala City",50,55,"7%")
}
---
